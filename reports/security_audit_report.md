...
2. ~~إضافة Rate Limiting~~ ✅ **مطبق** — جميع المسارات الرئيسية (news, search, directory, ads, media, auth, geographic) محمية بمعدل 10-60 طلب/دقيقة
3. **CORS** — غير مخصص (لكن Next.js يتعامل مع هذا)
