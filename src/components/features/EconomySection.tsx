...
export default function EconomySection({ news }: { news?: News[] }) {
  ...
  return (
    <section>
      <SectionHeader title="اقتصاد" href="/economy" />
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
        <div className="lg:col-span-3 group cursor-pointer">
          <div className="aspect-video bg-gradient-to-br from-amber-50 via-white to-amber-100/50 rounded-sm flex items-center justify-center text-gray-300 overflow-hidden relative mb-3">
